...
(function ($, _, undefined) {
    ...
    var defaultSettings = {
        ...
        templates     : {
            wrapper: _.template('<div contenteditable="true" class="mentions-input-box"></div>'),
            autocompleteList: _.template('<div contenteditable="true" class="mentions-autocomplete-list"></div>'),
    ...
    var MentionsInput = function (settings) {
        ...
        function addMention(mention) {
            ...
            var myVal = '['+mention.value+']';
          
            
            var updatedMessageText = start +myVal + end;
            elmInputBox.val(updatedMessageText); //Set the value to the txt area
	        elmInputBox.trigger('mention');
            updateValues();

            var s = $('#txtcomment').val();
           ...
           // utils.setCaratPosition(elmInputBox[0], startEndIndex);
            ...
            //var nyedva = document.getElementById('txtcomment');
            //nyedva.scrollWidth = 1000000;
